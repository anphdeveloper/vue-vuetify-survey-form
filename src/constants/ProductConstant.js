...
export const CLINIC__PRODUCT_RATE = [
    ...
    { min: 42, max: 42, rate: 38.10 },
    { min: 43, max: 43, rate: 39.22 },
    { min: 44, max: 44, rate: 40.40 },
